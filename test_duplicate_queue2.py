#!/usr/bin/env python
"""
Script to test duplicate analysis in the queue (second test)
"""
...
def test_duplicate_queue2():
    """Test duplicate analysis in the queue (second test)"""
    print("🧪 Testing Duplicate Analysis in Queue (Second Test)...")
    
    try:
        # Create a test data file
        test_data_file = DataFile.objects.create(
            file_name="test_duplicate_analysis_fixed.csv",
            file_size=3072,
            engagement_id="TEST-DUP-002",
            client_name="Test Duplicate Client 2",
        ...
        test_job = FileProcessingJob.objects.create(
            ...
            file_hash="test_duplicate_hash_fixed_1234567890abcdef",
