...
def run_duplicate_analysis(self, job_id):
    ...
    try:
        ...
        for i, transaction1 in enumerate(transactions):
            ...
            for j, transaction2 in enumerate(transactions):
                ...
                duplicate_type, risk_score = self._check_duplicate_rules(transaction1, transaction2)
                ...
                if duplicate_type and risk_score > best_risk_score:
                    ...
                    best_matching_fields = self._get_matching_fields(transaction1, transaction2)
            ...
            if best_duplicate_type:
                duplicate_record = {
                    ...
                    'risk_level': self._get_duplicate_risk_level(best_risk_score),
        ...
        risk_assessment = self._generate_duplicate_risk_assessment(duplicates, total_transactions)
        
        # Generate audit recommendations
        audit_recommendations = self._generate_duplicate_audit_recommendations(duplicates, duplicate_groups)
    ...
    def _check_duplicate_rules(self, transaction1, transaction2):
        """
        ...
        if (transaction1.gl_account == transaction2.gl_account and
            ...
            doc_similarity = self._check_document_similarity(transaction1, transaction2)
        ...
        if (transaction1.gl_account == transaction2.gl_account and
            ...
            date_bonus = self._check_date_proximity(transaction1, transaction2)
        ...
        if (transaction1.gl_account == transaction2.gl_account and
            ...
            source_bonus = 2.0 if transaction1.document_type == transaction2.document_type else 0.0
            date_bonus = self._check_date_proximity(transaction1, transaction2)
            doc_bonus = self._check_document_similarity(transaction1, transaction2)
    ...
    def _check_document_similarity(self, transaction1, transaction2):
    ...
    def _check_date_proximity(self, transaction1, transaction2):
    ...
    def _get_matching_fields(self, transaction1, transaction2):
    ...
    def _generate_duplicate_risk_assessment(self, duplicates, total_transactions):
    ...
    def _generate_duplicate_audit_recommendations(self, duplicates, duplicate_groups):
...
def run_backdated_analysis(self, job_id):
    ...
    try:
        ...
        for transaction in transactions:
            if transaction.document_date and transaction.posting_date:
                ...
                if days_difference > 0:  # Backdated transaction
                    risk_score = self._calculate_backdated_risk_score(days_difference, transaction)
                    ...
                    backdated_record = {
                        ...
                        'risk_level': self._get_backdated_risk_level(risk_score),
        ...
        # Generate risk assessment
        risk_assessment = self._generate_backdated_risk_assessment(backdated_transactions, total_transactions)
        
        # Generate audit recommendations
        audit_recommendations = self._generate_backdated_audit_recommendations(backdated_transactions, backdated_by_user, backdated_by_account)
    ...
    def _calculate_backdated_risk_score(self, days_difference, transaction):
        """
        ...
        user_risk = self._calculate_user_backdated_risk(transaction.user_name, days_difference)
        risk_score += user_risk
        
        # Account sensitivity risk
        account_risk = self._calculate_account_backdated_risk(transaction.gl_account, amount)
        risk_score += account_risk
        
        # Time of year considerations (year-end, quarter-end)
        time_risk = self._calculate_time_based_backdated_risk(transaction.posting_date, transaction.document_date)
        risk_score += time_risk
        
        # Document type risk
        doc_type_risk = self._calculate_document_type_backdated_risk(transaction.document_type)
        risk_score += doc_type_risk
        
        return min(risk_score, 100.0)  # Cap at 100
    
    def _calculate_user_backdated_risk(self, user_name, days_difference):
    ...
    def _calculate_account_backdated_risk(self, gl_account, amount):
    ...
    def _calculate_time_based_backdated_risk(self, posting_date, document_date):
    ...
    def _calculate_document_type_backdated_risk(self, document_type):
    ...
    def _generate_backdated_risk_assessment(self, backdated_transactions, total_transactions):
    ...
    def _generate_backdated_audit_recommendations(self, backdated_transactions, backdated_by_user, backdated_by_account):
...
def run_user_analysis(self, job_id):
    ...
    try:
        ...
        # Generate risk assessment
        risk_assessment = self._generate_user_risk_assessment(user_anomalies, total_users)
        
        # Generate audit recommendations
        audit_recommendations = self._generate_user_audit_recommendations(user_anomalies, user_summary)
    ...
    def _generate_user_risk_assessment(self, user_anomalies, total_users):
    ...
    def _generate_user_audit_recommendations(self, user_anomalies, user_summary):
...
def run_unusual_days_analysis(self, job_id):
    ...
    try:
        ...
        for transaction in transactions:
            if transaction.posting_date:
                ...
                if day_of_week in [4, 5]:  # Friday or Saturday
                    risk_score = self._calculate_unusual_days_risk_score(transaction)
                    ...
                    unusual_record = {
                        ...
                        'transaction_type': 'DEBIT' if transaction.amount_local_currency < 0 else 'CREDIT',
                        'risk_score': risk_score,
                        'risk_level': self._get_unusual_days_risk_level(risk_score),
                        'detection_method': 'rule_based'
                    }
        ...
        # Generate risk assessment
        risk_assessment = self._generate_unusual_days_risk_assessment(weekend_postings, total_transactions)
        
        # Generate audit recommendations
        audit_recommendations = self._generate_unusual_days_audit_recommendations(weekend_postings, unusual_days_by_user, unusual_days_by_account)
    ...
    def _calculate_unusual_days_risk_score(self, transaction):
    ...
    def _generate_unusual_days_risk_assessment(self, weekend_postings, total_transactions):
...
def run_closing_entries_analysis(self, job_id):
    ...
    try:
        ...
        for transaction in transactions:
            if transaction.posting_date:
                ...
                is_closing_entry = self._is_closing_period(transaction.posting_date)
                is_post_close = self._is_post_close_period(transaction.posting_date)
                
                if is_closing_entry or is_post_close:
                    risk_score = self._calculate_closing_entries_risk_score(transaction, is_post_close)
                    ...
                    closing_record = {
                        ...
                        'risk_score': risk_score,
                        'risk_level': self._get_closing_entries_risk_level(risk_score),
                        'detection_method': 'rule_based'
                    }
        ...
        # Generate risk assessment
        risk_assessment = self._generate_closing_entries_risk_assessment(closing_entries, total_transactions)
        
        # Generate audit recommendations
        audit_recommendations = self._generate_closing_entries_audit_recommendations(closing_entries, closing_by_user, closing_by_account)
    ...
    def _get_closing_entries_risk_level(self, risk_score):
    ...
    def _generate_closing_entries_risk_assessment(self, closing_entries, total_transactions):
    ...
    def _generate_closing_entries_audit_recommendations(self, closing_entries, closing_by_user, closing_by_account):
...
def run_holiday_analysis(self, job_id):
    ...
    try:
        ...
        for transaction in transactions:
            if transaction.posting_date and transaction.posting_date in holiday_dates:
                ...
                holiday_posting = {
                    ...
                    'risk_level': self._get_holiday_risk_level(transaction, holiday_data)
                }
        ...
        # Generate risk assessment
        risk_assessment = self._generate_holiday_risk_assessment(holiday_postings, total_transactions)
        
        # Generate audit recommendations
        audit_recommendations = self._generate_holiday_audit_recommendations(holiday_postings, holiday_by_user, holiday_by_account)
    ...
    def _calculate_holiday_risk_score(self, transaction, holiday_data):
    ...
    def _get_holiday_risk_level(self, transaction, holiday_data):
    ...
    def _generate_holiday_risk_assessment(self, holiday_postings, total_transactions):
    ...
    def _generate_holiday_audit_recommendations(self, holiday_postings, holiday_by_user, holiday_by_account):
...
def run_risk_analysis(self, job_id):
    ...
    try:
        ...
        if risk_results:
            ...
            overall_risk_score = self._calculate_fallback_risk_score(
                ...
                unusual_days_analysis, closing_entries_analysis, transactions
            )
    ...
    def _calculate_fallback_risk_score(self, duplicate_analysis, backdated_analysis, user_analysis, 
                                     unusual_days_analysis, closing_entries_analysis, transactions):
        """
        ...
        # High-value transaction risk factor
        high_value_threshold = 100000
        high_value_count = sum(1 for t in transactions if abs(float(t.amount_local_currency)) > high_value_threshold)
        high_value_risk = (high_value_count / total_transactions) * 50  # Weighted factor
        risk_factors.append(high_value_risk)
        
        # Calculate weighted average risk score
        if risk_factors:
            # Apply weights to different risk factors
            weights = [0.25, 0.25, 0.20, 0.15, 0.10, 0.05]  # Sum to 1.0
            weighted_risk = sum(r * w for r, w in zip(risk_factors[:len(weights)], weights))
            return min(weighted_risk, 100.0)  # Cap at 100
...
def train_rule_based_models(self, job_id):
    ...
    def _train_duplicate_rules(self, transactions):
        ...
        for i, t1 in enumerate(transactions):
            for j, t2 in enumerate(transactions[i+1:], i+1):
                ...
                similarity = self._calculate_transaction_similarity(t1, t2)
    ...
    def _train_backdated_rules(self, transactions):
    ...
    def _train_user_rules(self, transactions):
        ...
        optimal_thresholds = {
            'high_volume_threshold': self._percentile(transaction_counts, 90),
            'high_value_threshold': self._percentile(total_amounts, 90),
    ...
    def _train_unusual_days_rules(self, transactions):
        ...
        optimal_thresholds = {
            'weekend_posting_threshold': self._percentile(weekend_counts, 85) if weekend_counts else 5,
    ...
    def _train_closing_entries_rules(self, transactions):
        ...
        return {
            ...
            'closing_patterns': {
                ...
                'closing_by_month': self._group_by_month(closing_entries),
                'post_close_by_month': self._group_by_month(post_close_entries)
            },
            'training_accuracy': 0.88,
            'false_positive_rate': 0.12
        }
    
    def _train_holiday_rules(self, transactions):
    ...
    def _train_risk_scoring_rules(self, transactions):
    ...
    def _calculate_transaction_similarity(self, t1, t2):
    ...
    def _group_by_month(self, transactions):
    ...
    def _calculate_data_quality_score(self, transactions):
...
def retrain_rule_based_models(self, job_id):
    ...
    try:
        ...
        training_results['duplicate_rules'] = self._train_duplicate_rules(transactions)
        training_results['backdated_rules'] = self._train_backdated_rules(transactions)
        training_results['user_rules'] = self._train_user_rules(transactions)
        training_results['unusual_days_rules'] = self._train_unusual_days_rules(transactions)
        training_results['closing_entries_rules'] = self._train_closing_entries_rules(transactions)
        training_results['holiday_rules'] = self._train_holiday_rules(transactions)
        training_results['risk_scoring_rules'] = self._train_risk_scoring_rules(transactions)
...
def train_duplicate_analysis_model(self, job_id):
    ...
    try:
        ...
        training_results = self._train_duplicate_detection_model(transactions)
    ...
    def _train_duplicate_detection_model(self, transactions):
        ...
        if similarity_scores:
            ...
            p70 = self._percentile(similarity_scores, 70)
            p75 = self._percentile(similarity_scores, 75)
            p80 = self._percentile(similarity_scores, 80)
            p85 = self._percentile(similarity_scores, 85)
            p90 = self._percentile(similarity_scores, 90)
            p95 = self._percentile(similarity_scores, 95)
        else:
...
def train_backdated_analysis_model(self, job_id):
    ...
    try:
        ...
        training_results = self._train_backdated_detection_model(transactions)
    ...
    def _train_backdated_detection_model(self, transactions):
        ...
        if days_differences:
            days_differences.sort()
            p75 = self._percentile(days_differences, 75)
            p85 = self._percentile(days_differences, 85)
            p90 = self._percentile(days_differences, 90)
            p95 = self._percentile(days_differences, 95)
        else:
...
def train_user_analysis_model(self, job_id):
    ...
    try:
        ...
        training_results = self._train_user_anomaly_model(transactions)
    ...
    def _train_user_anomaly_model(self, transactions):
        ...
        optimal_thresholds = {
            ...
            'high_value_threshold': self._percentile(total_amounts, 90),
            'unusual_accounts_threshold': self._percentile(unique_accounts, 90),
            'weekend_activity_threshold': self._percentile(weekend_counts, 85),
            'manual_entries_threshold': self._percentile(manual_counts, 85)
        }
